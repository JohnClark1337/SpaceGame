...
public class DialogEditorDialog : Form
{
    ...
    public DialogEditorDialog(QuestDialog? existing = null)
    {
        ...
        _txtText = new TextBox { Location = new(12, y + 24), Size = new(440, 200), Multiline = true, AcceptsReturn = true };
        _txtText.AddTo(this);
        y += 230;
        ...
        var btnOk = new Button { Text = "OK", Location = new(270, y), Size = new(90, 32) };
        btnOk.AddTo(this);
        btnOk.Click += (_, _) => ValidateAndClose();

        var btnCancel = new Button { Text = "Cancel", Location = new(370, y), Size = new(90, 32), DialogResult = DialogResult.Cancel };
