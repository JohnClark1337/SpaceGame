...
public class QuestEditorDialog : Form
{
        ...
        List<string> upgradeIds, List<string> equipmentIds, List<string> resourceIds, QuestData? existing = null)
    {
        ...
        int y = 10, labelW = 120, inputW = 350;

        new Label { Text = "ID:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _txtId = new TextBox { Location = new(130, y), Size = new(inputW, 24) }; _txtId.AddTo(this);
        y += 36;

        new Label { Text = "Name:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _txtName = new TextBox { Location = new(130, y), Size = new(inputW, 24) }; _txtName.AddTo(this);
        y += 36;

        new Label { Text = "Description:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _txtDesc = new TextBox { Location = new(130, y), Size = new(inputW, 50), Multiline = true };
        _txtDesc.AddTo(this);
        y += 62;

        new Label { Text = "Objective Type:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbObjType = new ComboBox { Location = new(130, y), Size = new(160, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        _cmbObjType.Items.AddRange(["travel", "collect", "deliver", "destroy"]);
        _cmbObjType.SelectedIndex = 0;
        _cmbObjType.AddTo(this);
        y += 36;

        new Label { Text = "Target System:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbTargetSys = new ComboBox { Location = new(130, y), Size = new(inputW, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        ...
        new Label { Text = "Target Item:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbTargetItem = new ComboBox { Location = new(130, y), Size = new(inputW, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        ...
        new Label { Text = "Target Count:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _numTargetCount = new NumericUpDown { Location = new(130, y), Size = new(100, 24), Maximum = 999, Minimum = 1, Value = 1 };
        _numTargetCount.AddTo(this);
        y += 36;

        new Label { Text = "Giver System:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbGiverSys = new ComboBox { Location = new(130, y), Size = new(inputW, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        ...
        new Label { Text = "Quest Type:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbQuestType = new ComboBox { Location = new(130, y), Size = new(160, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        _cmbQuestType.Items.AddRange(["Standard", "QuestLine"]);
        _cmbQuestType.SelectedIndex = 0;
        _cmbQuestType.AddTo(this);
        y += 36;

        new Label { Text = "Next Quest:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbNextQuest = new ComboBox { Location = new(130, y), Size = new(inputW, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        _cmbNextQuest.Items.Add("");
        foreach (var qid in existingIds) _cmbNextQuest.Items.Add(qid);
        _cmbNextQuest.SelectedIndex = 0;
        _cmbNextQuest.AddTo(this);
        _cmbQuestType.SelectedIndexChanged += (_, _) =>
        {
            _cmbNextQuest.Enabled = _cmbQuestType.SelectedItem?.ToString() == "QuestLine";
        };
        _cmbNextQuest.Enabled = _cmbQuestType.SelectedItem?.ToString() == "QuestLine";
        y += 36;

        int btnX = 415, btnW = 65, btnH = 30;

        // Rewards
        new Label { Text = "Rewards:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _lstRewards = new ListBox { Location = new(130, y), Size = new(275, 56) };
        _lstRewards.AddTo(this);
        _btnAddReward = new Button { Text = "Add", Location = new(btnX, y), Size = new(btnW, btnH) };
        _btnAddReward.AddTo(this);
        _btnRemoveReward = new Button { Text = "Del", Location = new(btnX, y + 36), Size = new(btnW, btnH) };
        _btnRemoveReward.AddTo(this);
        y += 78;

        new Label { Text = "Defense System:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _cmbDefenseSys = new ComboBox { Location = new(130, y), Size = new(inputW, 24), DropDownStyle = ComboBoxStyle.DropDownList };
        ...
        // Required Resources
        new Label { Text = "Required Resources:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _lstReqResources = new ListBox { Location = new(130, y), Size = new(200, 56) };
        _lstReqResources.AddTo(this);
        _btnAddReq = new Button { Text = "Add", Location = new(340, y), Size = new(btnW, btnH) };
        _btnAddReq.AddTo(this);
        _btnRemoveReq = new Button { Text = "Del", Location = new(410, y), Size = new(btnW, btnH) };
        _btnRemoveReq.AddTo(this);
        y += 78;

        // Dialogs
        new Label { Text = "Dialogs:", Location = new(10, y + 3), Size = new(labelW, 20) }.AddTo(this);
        _lstDialogs = new ListBox { Location = new(130, y), Size = new(275, 56) };
        ...
        _btnOk = new Button { Text = "OK", Location = new(290, y), Size = new(100, 34) };
        _btnOk.AddTo(this);
        _btnOk.Click += (_, _) => ValidateAndClose();

        _btnCancel = new Button { Text = "Cancel", Location = new(400, y), Size = new(100, 34), DialogResult = DialogResult.Cancel };
        ...
        if (existing != null)
        {
            ...
            _cmbQuestType.SelectedItem = existing.QuestType;
            if (!string.IsNullOrEmpty(existing.NextQuestId)) _cmbNextQuest.SelectedItem = existing.NextQuestId;
    ...
    private void ValidateAndClose()
    {
        ...
        Quest = new QuestData
        {
            ...
            QuestType = _cmbQuestType.SelectedItem?.ToString() ?? "Standard",
            NextQuestId = string.IsNullOrWhiteSpace(_cmbNextQuest.SelectedItem?.ToString()) ? null : _cmbNextQuest.SelectedItem.ToString(),
...
public class ResourceKeyDialog : Form
{
    ...
    public ResourceKeyDialog(IEnumerable<string> existingKeys)
    {
        ...
        new Label { Text = "Resource ID:", Location = new(12, 18), Size = new(80, 20) }.AddTo(this);
        _txtId = new TextBox { Location = new(100, 15), Size = new(180, 24) }; _txtId.AddTo(this);

        new Label { Text = "Quantity:", Location = new(12, 54), Size = new(80, 20) }.AddTo(this);
        _numQty = new NumericUpDown { Location = new(100, 51), Size = new(100, 24), Maximum = 9999, Minimum = 1, Value = 1 };
        _numQty.AddTo(this);

        var btnOk = new Button { Text = "OK", Location = new(120, 90), Size = new(80, 30), DialogResult = DialogResult.OK };
        btnOk.AddTo(this);
        btnOk.Click += (_, _) => { if (string.IsNullOrWhiteSpace(_txtId.Text)) { MessageBox.Show("ID required."); DialogResult = DialogResult.None; } };

        var btnCancel = new Button { Text = "Cancel", Location = new(205, 90), Size = new(80, 30), DialogResult = DialogResult.Cancel };
        btnCancel.AddTo(this);
    }
}
